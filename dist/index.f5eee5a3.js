...
list.addEventListener("click", function(e) {
    if (e.target.matches("button")) deleteItem(parseInt(e.target.value));
    if (e.target.matches('input[type="checkbox"]')) markAsComplete(parseInt(e.target.value));
});
...
console.log(numbers, numbersCopy); // list.addEventListener('itemsUpdated', (e) => {
 //   console.log(e);
 // });

//# sourceMappingURL=index.f5eee5a3.js.map
