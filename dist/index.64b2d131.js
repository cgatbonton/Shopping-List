...
list.addEventListener("click", (e)=>{
    if (e.target.matches("button")) deleteItem(parseFloat(e.target.value));
});
list.addEventListener("input", (e)=>{
    if (e.target.matches("input")) markAsComplete(parseFloat(e.target.value));
});
list.addEventListener("itemsUpdated", displayItems);
list.addEventListener("itemsUpdated", mirrorToLocalStorage);
restoreFromLocalStorage(); // Challenge - put the done items at the bottom

//# sourceMappingURL=index.64b2d131.js.map
